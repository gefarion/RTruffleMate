...
def _is_letter(ivkbl, rcvr, args):
    code = ord(rcvr.get_embedded_character())
...
def _is_alphanumeric(ivkbl, rcvr, args):
    code = ord(rcvr.get_embedded_character())
...
def _is_lower_case(ivkbl, rcvr, args):
    code = ord(rcvr.get_embedded_character())
