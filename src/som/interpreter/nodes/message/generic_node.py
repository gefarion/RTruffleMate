...
class GenericMessageNode(AbstractMessageNode):
    ...
    def execute_evaluated(self, frame, rcvr, args):
        ...
        if we_are_jitted():
            return self._direct_dispatch(rcvr, args, frame)
        else:
            return self._dispatch.execute_dispatch(rcvr, args, frame)

    def _direct_dispatch(self, rcvr, args, call_frame):
